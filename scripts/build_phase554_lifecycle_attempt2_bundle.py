...
"""Build the deterministic qualification-only Phase 5.54 GPIO20 bundle."""
...
MEMBERS = (
    "release/phase5.54-lifecycle-attempt2-v1.json",
    "scripts/phase554_lifecycle_controls.py",
    "tools/gate_d_uapi_probe.c",
)
PREFIX = "rp1-gpclk-dkms-phase5.54-lifecycle-attempt2-controls"
