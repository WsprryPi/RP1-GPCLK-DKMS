...
class FakeSystem:
    ...
    def op_load_disabled(self):
        if "0.0.0-phase5.33" not in self.dkms or not self.overlay: raise ValueError("load precondition")
    ...
    def op_remove_failed_successor(self): self.dkms.discard("0.0.0-phase5.33")
