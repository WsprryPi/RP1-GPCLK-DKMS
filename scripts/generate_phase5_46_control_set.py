...
def generate(output_root: pathlib.Path) -> list[pathlib.Path]:
    ...
    instance["authorization"].update(
        ...
        approvalScope=("Operator-authorized exact Phase 5.46 output-disabled Gate D scope "
                       "committed at b65410f9301428878decfe1e4cb05aea9a2b9b35; limited to "
                       ...
                       "schema-5 transition, sealed-root policy and module graph, recovery, "
