...
def validate(value:dict)->dict:
 ...
 if value["runtime"]!={"moduleLoaded":False,"endpointPresent":False,"overlayActive":False,"dkmsTestVersions":False,"outputActive":False}: raise ValueError("snapshot runtime is active")
