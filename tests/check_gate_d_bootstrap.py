...
with tempfile.TemporaryDirectory() as temporary:
    ...
    plan={"SPDX-License-Identifier":"MIT","schemaVersion":1,"kind":"gate-d-qualification-bootstrap-plan","operationId":"phase5.18-bootstrap","hostId":"wspr5-stock","predecessorVersion":"0.0.0-phase5.2","kernelRelease":"kernel","stagingDirectory":"/var/lib/rp1-gpclk-dkms/gate-d/bootstrap","candidate":{"release":"0.0.0-phase5.23","sourceCommit":"1"*40,"archive":"/inputs/candidate.tar.gz","archiveSha256":sha(archive)},"qualificationIdentity":{"path":"/inputs/identity.json","sha256":sha(identity)},"administrator":{"sourcePath":"source/admin.py","sourceSha256":sha(admin),"bootstrapPath":"/inputs/extracted/scripts/rp1-gpclk-admin.py","installedPath":installed,"installedSha256":sha(admin)},"argv":["/usr/bin/python3","/inputs/extracted/scripts/rp1-gpclk-admin.py","install","--execute","--release-directory","/inputs","--route","gpio4","--qualification-install","--qualification-identity","/inputs/identity.json"],"cleanupArgv":["/usr/libexec/rp1-gpclk-dkms/gate-d-lifecycle","dispatch","complete-removal","0.0.0-phase5.2","0.0.0-phase5.23","kernel","/var/lib/rp1-gpclk-dkms/gate-d/bootstrap","--execute"],"recoveryArgv":["/usr/bin/python3","/inputs/extracted/scripts/rp1-gpclk-admin.py","recover","--execute"],"journal":"/state/bootstrap.json","deadlineSeconds":1800,"expectedPreState":{"moduleLoaded":False,"endpointPresent":False,"overlayActive":False,"dkmsTestVersions":False,"liveOutput":False},"expectedPostState":{"moduleLoaded":False,"endpointPresent":False,"overlayActive":False,"dkmsTestVersions":False,"liveOutput":False},"retainedTools":[{"path":tool_path,"sha256":hashlib.sha256(b"executor").hexdigest()}],"cleanupPaths":["/var/lib/rp1-gpclk-dkms/gate-d/bootstrap"],"safety":{"outputDisabled":True,"liveOutput":False,"gpioAccess":False,"clockEnabled":False,"dmaActive":False,"sdrActive":False,"rf":False}}
