...
def frozen_payload(relative, expected):
 p=ROOT/relative
 if p.is_file() and hashlib.sha256(p.read_bytes()).hexdigest()==expected: return p.read_bytes()
 payload=subprocess.check_output(["git","show","2a6ddeb8e0f7d31a26bbe4ebdc4bc0458a41c8c5:"+relative],cwd=ROOT)
