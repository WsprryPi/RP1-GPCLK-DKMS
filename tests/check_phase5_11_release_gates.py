...
ORDER = [
    ...
    "final-artifact-reproduction", "final-candidate-target-verification",
    "release-review-and-claim-audit",
...
def validate(value: dict) -> None:
    ...
    if value.get("release") != "1.0.0" or value.get("debianVersion") != "1.0.0-1":
    ...
    if value.get("currentClassification") != "target-verified-release-candidate-awaiting-review":
...
for mutation in (
    ...
    lambda value: value["gates"][11].update(status="passed"),
