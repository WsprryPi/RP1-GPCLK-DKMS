...
with tempfile.TemporaryDirectory() as temporary:
    ...
    instance={"schemaVersion":6,"kind":"gate-d-representative-system-execution-instance","qualificationRoot":reference,"executionPolicy":{"targetPlan":"release/plan.json","targetPlanSha256":sha(plan_path)}}
    ...
    schema5_instance=copy.deepcopy(instance); schema5_instance["schemaVersion"]=5
    schema5_instance_path=release/"schema5-instance.json"; schema5_instance_path.write_text(json.dumps(schema5_instance,sort_keys=True)+"\n")
    loaded,loaded_root=executor.bootstrap_root_validator(schema5_instance_path,installed_root=fake_root,current_executor_override=override)
    assert loaded==schema5_instance and loaded_root==qualification
...
print("Gate D exact installed schema-6 permanent-executor import graph: PASS")
