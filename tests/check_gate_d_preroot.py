...
def make_envelope(prefix:pathlib.Path)->dict:
    ...
    archive=prefix/"staging/rp1-gpclk-dkms-0.0.0-phase5.39.tar.gz"; archive.write_bytes(b"candidate\n")
    sidecars={
    ...
    marker={"SPDX-License-Identifier":"MIT","schemaVersion":1,"kind":"gate-d-qualification-root-identity","rootPath":"/qualification/root","candidateRelease":"0.0.0-phase5.39","sourceCommit":"1"*40}
