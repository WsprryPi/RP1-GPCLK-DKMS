...
with tempfile.TemporaryDirectory() as temporary:
    ...
    marker={"SPDX-License-Identifier":"MIT","schemaVersion":1,"kind":"gate-d-qualification-root-identity","rootPath":str(root),"candidateRelease":"0.0.0-phase5.49","sourceCommit":"1"*40}
