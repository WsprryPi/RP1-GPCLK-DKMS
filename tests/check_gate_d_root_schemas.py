...
root={"path":"/home/pi/gate-d-qualification/phase5.20","identityFile":".gate-d-root.json","identitySha256":"1"*64,"ownerUid":1000,"mode":"0700"}
bootstrap={"SPDX-License-Identifier":"MIT","schemaVersion":2,"kind":"gate-d-qualification-bootstrap-plan","operationId":"x","hostId":"h","qualificationRoot":root,"predecessorVersion":"p","kernelRelease":"k","stagingDirectory":"/s","candidate":{},"qualificationIdentity":{},"administrator":{},"argv":[],"cleanupArgv":[],"recoveryArgv":[],"journal":"/j","deadlineSeconds":1,"expectedPreState":{},"expectedPostState":{},"retainedTools":[{}],"cleanupPaths":["/c"],"safety":{}}
target={"SPDX-License-Identifier":"MIT","schemaVersion":4,"kind":"gate-d-output-disabled-target-operation-plan","qualificationRoot":root,"qualificationBootstrap":{},"hostId":"h","tooling":{},"invariants":{},"services":[],"artifacts":{},"boot":{},"attemptEnvelope":{},"rows":[]}
...
instance=json.loads((ROOT/"release/gate-d-execution-instance-v1.json").read_text()); instance["schemaVersion"]=3; instance["qualificationRoot"]=root
