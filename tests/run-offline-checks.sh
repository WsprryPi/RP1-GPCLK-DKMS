...
python3 "$repo_dir/tests/check_release_1_0_1_compatibility_manifest.py"
...
python3 "$repo_dir/tests/check_release_1_0_0_repaired_target_success.py"
python3 "$repo_dir/tests/check_release_1_0_0_public_download_success.py"
