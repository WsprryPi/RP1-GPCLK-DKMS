...
python3 "$repo_dir/tests/check_phase553_final_staging_validation_stop.py"
python3 "$repo_dir/tests/check_phase553_bounded_wrapup_readiness.py"
python3 "$repo_dir/tests/check_phase553_bounded_wrapup_evidence.py"
python3 "$repo_dir/tests/check_phase553_qualification_only_installer.py"
python3 "$repo_dir/tests/check_phase553_qualification_only_install_successor.py"
python3 "$repo_dir/tests/check_phase553_final_qualification_only_split_offline_twice.py"
python3 "$repo_dir/tests/check_phase553_installed_uapi_qualification_repair.py"
