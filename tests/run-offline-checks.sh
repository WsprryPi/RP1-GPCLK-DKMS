...
python3 "$repo_dir/tests/check_target_fault_contract.py"
...
python3 "$repo_dir/tests/check_runtime_provider.py"
python3 "$repo_dir/tests/check_runtime_activation.py"
