...
required_ids = {"source-archive", "module-source", "module-headers", "kbuild", "makefile", "dkms-conf", "kernel-module",
                ...
                "representative-system-matrix", "gate-d-bootstrap-schema", "gate-d-root-schema", "gate-d-target-plan-schema", "gate-d-attempt-index-schema", "gate-d-execution-schema", "gate-d-pre-root-schema", "gate-d-instance-validator", "gate-d-lifecycle-tool", "gate-d-platform-tool", "gate-d-boot-tool", "gate-d-target-plan-tool", "gate-d-attempt-generator", "gate-d-bootstrap-tool", "gate-d-root-tool", "gate-d-bootstrap-module", "gate-d-target-plan-module", "gate-d-lifecycle-module", "gate-d-outer-module", "gate-d-attempts-module", "gate-d-instance-module", "gate-d-pre-root-module", "gate-d-permanent-executor", "gate-d-busy-injector-source", "gate-d-busy-injector-header", "gate-d-busy-injector", "gate-d-uapi-probe-source", "gate-d-uapi-probe", "release-integration-gates", "calibrated-review-release-policy", "lifecycle-policy-tool", "diagnostic-tool", "operator-docs",
