...
capture=load_module("capture",ROOT/"scripts/gate_d_live_snapshot.py"); independent=load_module("independent",ROOT/"scripts/gate_d_live_snapshot_validate.py")
...
with tempfile.TemporaryDirectory() as temporary:
 ...
 ledger={"status":"complete","release":"0.0.0-current","checkpoint":"commit-state","recoveryRequired":False,"liveOutput":False,"replacedFiles":[{"path":"/usr/libexec/rp1-gpclk-dkms/tool","status":"committed"},{"path":"/usr/sbin/tool","status":"committed"}]}
...
print("Gate D canonical live-target snapshot and independent comparison: PASS")
